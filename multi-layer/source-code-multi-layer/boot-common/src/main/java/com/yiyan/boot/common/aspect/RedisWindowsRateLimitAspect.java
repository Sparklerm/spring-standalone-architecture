package com.yiyan.boot.common.aspect;

import cn.hutool.core.util.StrUtil;
import com.yiyan.boot.common.annotation.RedisWindowRateLimit;
import com.yiyan.boot.common.enums.BizCodeEnum;
import com.yiyan.boot.common.enums.RedisLimitLevel;
import com.yiyan.boot.common.enums.RedisLimitType;
...
public class RedisWindowsRateLimitAspect {
    ...
    @Pointcut("@annotation(com.yiyan.boot.common.annotation.RedisWindowRateLimit)")
    ...
    private void flexLimit(String key, int timeWindow, int maxPermits) {
        ...
        if (!allowed) {
            BizAssert.fail(BizCodeEnum.REQUEST_FREQUENTLY);
        }
    }
