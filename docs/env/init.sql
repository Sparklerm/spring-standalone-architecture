...
(
  ...
  AUTO_INCREMENT = 8
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='后台用户角色表';
...
(
  ...
  AUTO_INCREMENT = 253
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='后台角色资源关系表';
...
INSERT INTO `role`
    (id, name, description, admin_count, status, create_time, update_time)
VALUES (1, '系统管理员', '可访问全部资源', 0, 1, now(), NULL);
...
VALUES (1, '权限资源', now(), NULL);

INSERT INTO resource
    (id, name, url, description, category_id, create_time, update_time)
VALUES (1, '后端资源管理API', '/resource/**', '', 1, now(), NULL),
       (2, '后台角色管理API', '/role/**', '', 1, now(), NULL),
       (3, '后台用户管理API', '/user/**', '', 1, now(), NULL),
       (4, '后台资源分类管理API', '/resourceCategory/**', '', 1, now(), NULL);
