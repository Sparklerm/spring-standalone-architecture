package com.yiyan.boot.common.utils.excel.core;

import com.alibaba.excel.EasyExcelFactory;
import com.alibaba.excel.read.listener.PageReadListener;
import com.alibaba.excel.read.metadata.ReadSheet;
import com.yiyan.boot.common.utils.excel.common.ExcelCommon;
import com.yiyan.boot.common.utils.excel.core.listener.CommonListener;
import com.yiyan.boot.common.utils.excel.model.ExcelSheetData;
import com.yiyan.boot.common.utils.excel.model.ExcelSheetParam;
...
public class ExcelRead {
     ...
     * @return excel数据
     */
    public static <T> List<T> read(String fileName, Class<T> clazz, int headRowNumber) {
        List<T> excelData = new ArrayList<>();
        List<ReadSheet> readSheets = ExcelCommon.hasSheets(fileName);
        for (ReadSheet readSheet : readSheets) {
            EasyExcelFactory.read(fileName, clazz, new PageReadListener<T>(excelData::addAll))
